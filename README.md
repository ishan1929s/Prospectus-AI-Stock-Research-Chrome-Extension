...
- [x] **Manifest V3 Core**: Side Panel, Content Scripts, Service Worker, and Background Alarms.
- [x] **Multi-Provider BYOK**: Native direct integration with Claude, OpenAI, Gemini, and OpenRouter.
- [x] **Deterministic LCS Diff Engine**: Exact sentence-level additions and deletions with Jaccard metrics.
- [x] **Editorial Design System**: Anthropic-inspired warm cream and coral UI.
- [ ] **Interactive XBRL Financial Statements**: Dynamic chart generation directly from SEC inline XBRL data.
- [ ] **On-Device Local SLMs**: Support for Chrome Built-in AI (`window.ai` Prompt API) and WebGPU for zero-cost offline analysis.
- [ ] **Encrypted P2P Research Sync**: WebRTC-based end-to-end encrypted note sharing across institutional research pods.

---

## ⚖️ Compliance & Non-Advisory Notice

> **Regulatory Disclaimer**: Prospectus is an informational research and productivity tool designed solely to assist users in reading, organizing, and comparing public corporate disclosures. Prospectus is **not** a registered investment adviser, broker-dealer, or financial analyst. Prospectus does **not** provide investment advice, financial planning, price targets, buy/sell recommendations, or endorsement of any securities. All analyses are generated using third-party AI models based on public disclosures and must be independently verified by the user.

---

<div align="center">

**Crafted with obsession for financial clarity, computer science rigor, and zero-compromise user privacy.**

*Designed and engineered by [Ishan Sharma](https://github.com/ishan1929s).*
